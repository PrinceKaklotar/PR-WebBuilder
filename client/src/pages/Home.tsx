  ...
  return (
       ...
       */}
       <br /><br />
        ...
        <form onSubmit={onSubmitHandler} className="bg-white/10 max-w-2xl w-full rounded-xl p-4 mt-10
                                border border-white-600/70
                                focus-within:ring-2 ring-white-500
                                shadow-[0_0_25px_rgba(34,197,94,0.5)]
                                transition-all"
                              >
          <textarea onChange={e => setInput(e.target.value)} className="bg-transparent outline-none text-gray-300 resize-none w-full text-xl" rows={4}  placeholder="Describe your presentation in details" required />
